...
public:
    ...
    HTTPRequest& request() noexcept { return _request; } //?kdw
    const HTTPRequest& request() const noexcept { return _request; }//?kdw
...
protected:
	...
	virtual void onReceivedRequestInternal(const HTTPRequest& request);
};
