...
public:
    ...
    */
    UDPServer(const std::shared_ptr<Service>& service, const boost::asio::ip::udp::endpoint& endpoint);
    ...
    std::shared_ptr<boost::asio::io_service>& io_service() noexcept { return _io_service; }
    //! Get the Asio service strand for serialized handler execution
    boost::asio::io_service::strand& strand() noexcept { return _strand; }
    //! Get the server endpoint
    boost::asio::ip::udp::endpoint& endpoint() noexcept { return _endpoint; }
    //! Get the server multicast endpoint
    boost::asio::ip::udp::endpoint& multicast_endpoint() noexcept { return _multicast_endpoint; }
    ...
    */
    ...
    /*!
        ...
        \return 'true' if the server was successfully started, 'false' if the server failed to start
    */
    virtual bool Start(const boost::asio::ip::udp::endpoint& multicast_endpoint);
    //! Stop the server
    /*!
    ...
    */
    virtual size_t Send(const boost::asio::ip::udp::endpoint& endpoint, const void* buffer, size_t size);
    ...
    /*!
        ...
        \return Size of sent datagram
    */
    virtual size_t Send(const boost::asio::ip::udp::endpoint& endpoint, std::string_view text) { return Send(endpoint, text.data(), text.size()); }
    ...
    /*!
        ...
        \return Size of sent datagram
    */
    virtual size_t Send(const boost::asio::ip::udp::endpoint& endpoint, const void* buffer, size_t size, const CppCommon::Timespan& timeout);
    ...
    /*!
        ...
        \return Size of sent datagram
    */
    virtual size_t Send(const boost::asio::ip::udp::endpoint& endpoint, std::string_view text, const CppCommon::Timespan& timeout) { return Send(endpoint, text.data(), text.size(), timeout); }
    ...
    */
    virtual bool SendAsync(const boost::asio::ip::udp::endpoint& endpoint, const void* buffer, size_t size);
    ...
    */
    virtual bool SendAsync(const boost::asio::ip::udp::endpoint& endpoint, std::string_view text) { return SendAsync(endpoint, text.data(), text.size()); }
    ...
    */
    virtual size_t Receive(boost::asio::ip::udp::endpoint& endpoint, void* buffer, size_t size);
    ...
    */
    virtual std::string Receive(boost::asio::ip::udp::endpoint& endpoint, size_t size);
    ...
    /*!
        ...
        \return Size of received datagram
    */
    virtual size_t Receive(boost::asio::ip::udp::endpoint& endpoint, void* buffer, size_t size, const CppCommon::Timespan& timeout);
    ...
    /*!
        ...
        \return Received text
    */
    virtual std::string Receive(boost::asio::ip::udp::endpoint& endpoint, size_t size, const CppCommon::Timespan& timeout);
...
protected:
    ...
    */
    virtual void onReceived(const boost::asio::ip::udp::endpoint& endpoint, const void* buffer, size_t size) {}
    ...
    */
    virtual void onSent(const boost::asio::ip::udp::endpoint& endpoint, size_t sent) {}
