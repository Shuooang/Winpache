...
public:
    ...
    */
    SSLServer(const std::shared_ptr<Service>& service, const std::shared_ptr<SSLContext>& context, const boost::asio::ip::tcp::endpoint& endpoint);
    ...
    boost::asio::ip::tcp::endpoint& endpoint() noexcept { return _endpoint; }
    //! Get the server acceptor
    boost::asio::ip::tcp::acceptor& acceptor() noexcept { return _acceptor; }
