...
public:
    ...
    */
    SSLClient(const std::shared_ptr<Service>& service, const std::shared_ptr<SSLContext>& context, const boost::asio::ip::tcp::endpoint& endpoint);
    ...
    std::shared_ptr<boost::asio::io_service>& io_service() noexcept;
    //! Get the Asio service strand for serialized handler execution
    boost::asio::io_service::strand& strand() noexcept;
    //! Get the client SSL context
    std::shared_ptr<SSLContext>& context() noexcept;
    //! Get the client endpoint
    boost::asio::ip::tcp::endpoint& endpoint() noexcept;
    //! Get the client SSL stream
    boost::asio::ssl::stream<boost::asio::ip::tcp::socket>& stream() noexcept;
    //! Get the client socket
    boost::asio::ssl::stream<boost::asio::ip::tcp::socket>::next_layer_type& socket() noexcept;
