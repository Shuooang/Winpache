...
public:
    ...
    */
    ...
    boost::asio::ssl::stream<boost::asio::ip::tcp::socket>& stream() noexcept { return _stream; }
    //! Get the session socket
    boost::asio::ssl::stream<boost::asio::ip::tcp::socket>::next_layer_type& socket() noexcept { return _stream.next_layer(); }
    boost::asio::ssl::stream<boost::asio::ip::tcp::socket>::next_layer_type& kwsocket() noexcept { return _stream.next_layer(); }
...
protected:
    ...
    */
    ...
    virtual void onSentKw(uint8_t* data, size_t szAll) {}
