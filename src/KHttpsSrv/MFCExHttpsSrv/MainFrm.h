...
class CMainFrame : public CMDIFrameWndExInvokable //CMDIFrameWndEx
{
...
public:
	...
	afx_msg void OnInitodbc();
	afx_msg void OnCreateTableBasic();
	afx_msg void OnTableSample();
	afx_msg void OnDownloadOpenSSL();
	afx_msg void OnDockOdbcSetting();
	afx_msg void OnViewOdbCconnect();
	afx_msg void OnViewTestAPI();
	afx_msg void OnUpdateViewOdbcConnect(CCmdUI* pCmdUI);
	afx_msg void OnUpdateViewTestAPI(CCmdUI* pCmdUI);
	afx_msg void OnGotoProject();
	afx_msg void OnGotoOutput();
	afx_msg void OnRunHeidiSQL();
	afx_msg void OnCopyRequest();
