...
public:
	...
	string CheckDB(PWS sDSN = nullptr) override;
	
	//KDatabase* getDB(JObj& jpa) override;
	...
	int ClientException(KDatabase& _db, JObj& jpa, JObj& jrs, int iOp);

	int SampleSelectUUID(KDatabase& _db, JObj& jpa, JObj& jrs, int iOp);
